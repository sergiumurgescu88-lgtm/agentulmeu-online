      ...
      {mobileOpen && (
        <div className="md:hidden glass-strong mt-3 mx-6 rounded-xl p-4 space-y-3">
          ...
          <div className="pt-3 border-t border-white/10 flex gap-3">
            <Button variant="ghost" className="flex-1 text-white/80">Log In</Button>
            <Button className="flex-1 bg-gradient-to-r from-cyan-400 to-purple-500 text-white border-0">
              Începe Gratuit
            </Button>
          </div>
        </div>
